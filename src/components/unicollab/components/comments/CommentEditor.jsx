...
const CommentEditor = ({
  ...
  if (!user) {
    return (
      <div className="rounded-2xl border border-slate-800 bg-[#10141d] p-6 text-center">
        ...
        <Link
          to="/login"
          className="inline-flex rounded-xl bg-blue-600 px-5 py-2 font-medium text-white transition hover:bg-blue-700"
        >
          Login
        </Link>
      </div>
  ...
  return (
    <form
      ...
      className="rounded-2xl border border-slate-800 bg-[#10141d] p-5"
    >
      <textarea
        value={content}
        autoFocus={autoFocus}
